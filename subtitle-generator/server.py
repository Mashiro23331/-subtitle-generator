...
def _translate_deepl(entries, api_key, tasks, task_id):
    ...
    for bi in range(0, len(entries), BATCH):
        ...
        try:
            data = _json.dumps({'text': texts, 'source_lang': 'JA', 'target_lang': 'ZH'}).encode()
            req = urllib.request.Request(
                'https://api-free.deepl.com/v2/translate' if 'free' in key else 'https://api.deepl.com/v2/translate',
                data=data,
